...
class SettingsPage(BasePage):
    ...
    def _build_general_section(self, parent):
        ...
        # General toggles
        self._build_toggle_setting(section, "Start on Boot", "start_on_boot", False)
        self._build_toggle_setting(section, "Minimize to Tray", "minimize_to_tray", False)
        
        # Language (Placeholder for now)
        lang_frame = tk.Frame(section, bg=Colors.SURFACE_ALT, padx=Space.MD, pady=Space.SM)
