...
class Sidebar(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(header, text="Secure LoRa desktop", bg=Colors.SURFACE_SIDEBAR, fg=Colors.TEXT_SECONDARY,
        ...
        tk.Label(card, text="Connection", bg=Colors.SURFACE_ALT, fg=Colors.TEXT_MUTED,
